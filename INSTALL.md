...
```sh
git clone git@github.com:O-clock-Yuna/React-modele.git
...
# depuis dossier perso (environ)
cp -n ../../../oclock/React/React-modele/{.*,.*} .
...
#depuis dossier perso (environ)
cp -rn ../../../oclock/React/React-modele/{src,config,public} .
